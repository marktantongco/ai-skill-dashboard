...
5. For each repo with changes: `cd <repo> && OPENCODE_YOLO=true git add AGENTS.md && OPENCODE_YOLO=true git commit -m "Sync system prompt <tag>"`
6. Optional push (only if yolo mode confirmed): `OPENCODE_YOLO=true git push`
